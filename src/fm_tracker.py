...
class FM_Tracker:
    ...
    def __init__(self, init_im1, init_im2, init_bbox1, init_bbox2, config):
        ...
        self.model_choice = config["fm_tracker"]["model_choice"]
        self.zero_padding = config["fm_tracker"]["zero_padding"]
        self.surrounding = config["fm_tracker"]["surrounding"]
        self.zero_mapping_size = config["fm_tracker"]["zero_mapping_size"]
        self.norm = config["fm_tracker"]["norm"]
        self.step_length = config["fm_tracker"]["step_length"]
        self.number_candidates = config["fm_tracker"]["number_candidates"]
        self.pooling_type = config["fm_tracker"]["pooling_type"]
        self.pooling_mode = config["fm_tracker"]["pooling_mode"]
        self.layer_index = config["fm_tracker"]["layer_index"]
